...
void main() {
  ...
  print(
    'U64 Max evaluates native Dart signed limit strictly naturally: ${huge.value}',
  );
  ...
  print(
    'Uint16 hex bitwise shift (0x00FF << 8) = ${shifted.value} (Matches Mask: ${shifted.value == mask.value})\n',
  );
  ...
  print(
    'Unsigned Operator Logic: Is Uint8(255) literally > Uint8(0)? ${uMax > uZero}',
  );
